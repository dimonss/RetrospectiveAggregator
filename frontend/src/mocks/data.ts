...
export const MOCK_ROOM: RetroRoom = {
  ...
  cards: [
    { id: 'c1', text: 'Отличная коммуникация в команде', authorId: 'u1', columnId: 'col-1', votes: ['u2', 'u3', 'u4'], actionItems: [] },
    { id: 'c2', text: 'Быстро закрыли технический долг', authorId: 'u2', columnId: 'col-1', votes: ['u1', 'u3'], actionItems: [] },
    { id: 'c3', text: 'Успели задеплоить раньше дедлайна', authorId: 'u3', columnId: 'col-1', votes: ['u1'], actionItems: [] },
    { id: 'c4', text: 'Слишком долгий код-ревью', authorId: 'u2', columnId: 'col-2', votes: ['u1', 'u3', 'u4'], actionItems: [] },
    { id: 'c5', text: 'Нет четких требований от продукта', authorId: 'u4', columnId: 'col-2', votes: ['u2', 'u3'], actionItems: [] },
    { id: 'c6', text: 'Код-ревью занимает больше 2 дней', authorId: 'u1', columnId: 'col-2', votes: ['u2'], actionItems: [] },
    { id: 'c7', text: 'Настроить автоматическую сборку', authorId: 'u3', columnId: 'col-3', votes: ['u1', 'u2', 'u3', 'u4'], actionItems: [] },
    { id: 'c8', text: 'Провести воркшоп по DDD', authorId: 'u1', columnId: 'col-3', votes: ['u2', 'u4'], actionItems: [] },
  ],
  clusters: [],
};
