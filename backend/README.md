...
Серверная часть платформы для проведения ретроспектив. Работает в качестве Backend-for-Frontend (BFF), проксируя авторизацию через внешний сервис [ChalyshAuth](https://chalysh.pro/auth/api/docs) и локально кэшируя/сохраняя профили пользователей в SQLite.
